...
| (*Single-select mode with search filtering.*) |
| :---: |
| ![Single Select Dropdown Preview](./assets/dropdown-single.png) |

| (*Multi-select mode with checkmarks and "+ N more" tag display.*) |
| :---: |
| ![Multi-Select Dropdown Preview](./assets/dropdown-multi.png) |
...
| triggerHeight| string | `''` | Optional CSS height for the trigger button (e.g. `'35px'`). |
| triggerWidth | string | `''` | Optional CSS width for the trigger button (e.g. `'200px'`). |
